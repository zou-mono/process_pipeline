    ...
    public static class PolylineExtractor
    {
            ...
            bool isFromSideDatabase)
        {
            ...
            return new CadSegment
            {
                ...
                SourceHandles = new List<string> { line.ObjectId.Handle.ToString() },
            ...
            for (int i = 0; i < segmentCount; i++)
            {
                ...
                if (Math.Abs(bulge) < 1e-12)
                {
                    ...
                    result.Add(new CadSegment
                    {
                        ...
                        End = e,
                        Geometry = geometryFactory.CreateLineString(new[] { s, e }),
                        SourceHandles = new List<string> { pl.ObjectId.Handle.ToString() },
            ...
            bool isFromSideDatabase)
        {
            ...
            for (int i = 0; i < points.Count - 1; i++)
            {
                ...
                result.Add(new CadSegment
                {
                    ...
                    End = e,
                    Geometry = geometryFactory.CreateLineString(new[] { s, e }),
                    SourceHandles = new List<string> { sourceObjectId .Handle.ToString() } ,
