...
{
    /// <summary>
    /// 自定义Splitter控件CompositeSplitter的核心
    /// </summary>
    public class Splitter
    {
        ...
        public class CompositeSplitter : Control
        {
            ...
            {
                DefaultStyleKeyProperty.OverrideMetadata(typeof(CompositeSplitter),
                    new FrameworkPropertyMetadata(typeof(CompositeSplitter)));
                }
                public CompositeSplitter()
                {
                CommandBindings.Add(new CommandBinding(SplitterCommands.TogglePrimaryOnly, OnTogglePrimaryOnly));
                CommandBindings.Add(new CommandBinding(SplitterCommands.ToggleSecondaryOnly, OnToggleSecondaryOnly));
                CommandBindings.Add(new CommandBinding(SplitterCommands.RestoreNormal, OnRestoreNormal));
            }
